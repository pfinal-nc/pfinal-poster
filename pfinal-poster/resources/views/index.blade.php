            ...
            <div class="card-body">
                <div class="row">
                    @if(count($poster_list)>0)
                        @foreach($poster_list as $item)
                            <div class="col-sm-4 col-md-4">
                                <a href="{{url('poster_info/'.$item->id)}}">
                                    <div class="thumbnail">
                                        <img src="{{asset($item->poster_image)}}" width="100%" height="500" alt="...">
                                        <div class="caption" style="border-top: 1px dotted #cccccc">
                                            <p class="padding"><span style="color: #1d68a7">{{$item->title}}</span></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
